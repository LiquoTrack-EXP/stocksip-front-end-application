...
import { CatalogService } from '@/procurement/services/procurement.service.js';
import { WarehouseService, ProductService } from '@/inventorymanagement/services/inventory.service.js';
